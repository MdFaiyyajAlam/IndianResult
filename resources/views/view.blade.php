...
<body>
    <nav class="navbar navbar-expand navbar-dark bg-warning">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a href="/" class="nav-link btn btn-dark">Home</a></li>
        <li class="nav-item"><a href="{{route('insertresults')}}" class=" btn btn-dark nav-link">Insert</a></li>
            <li class="nav-item"><a href="" class="nav-link btn btn-dark btn-sm">About us</a></li>
        </ul>
    </nav>
    @section('content')
